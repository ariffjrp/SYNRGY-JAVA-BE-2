...
public class MerchantController {
    ...
    public ResponseEntity<Map<String, Object>> getOpenMerchants() {
        try {
    ...
    public ResponseEntity<Map<String, Object>> getIncomeMerchantId(@PathVariable UUID id){
        try {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Map<String, Object>> getMerchantId(@PathVariable UUID id){
        try {
            Merchant merchant = merchantService.getMerchantById(id);
            Map<String, Object> response = new HashMap<>();
    ...
    @PostMapping
    public ResponseEntity<Map<String, Object>> createMerchant(@RequestBody Merchant merchant) {
        try {
